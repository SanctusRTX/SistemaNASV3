...
function configurarBotonesCarpetaEspecial(intentos) {
    // Limitar a 3 intentos para evitar loop infinito
    intentos = intentos || 0;
    if (intentos >= 3) {
        console.log("[renombrar.js] Sin botones de renombrar para configurar, deteniendo.");
        return;
    }
    ...
    if (botonesConfigurados === 0 && intentos < 2) {
        setTimeout(function() { configurarBotonesCarpetaEspecial(intentos + 1); }, 1000);
    }
}
